    ...
    <div className="absolute top-2 left-4 border border-gray-100 w-[260px] sb:w-[300px] sbb:w-[350px] tb:w-[330px] tbbb:w-[350px] tbb:w-[500px] md:w-[520px] lgg:w-[400px] lggg:w-[500px]">
      ...
      <div className="flex">
        ...
        <div>
          <p className="p-2 text-gray-400">
            {data && data.friendsWithUserInfo
              ? data.friendsWithUserInfo.length
              : 0}
          </p>
        </div>
      </div>
      ...
      <div>
        <div className="grid gap-5 mt-3">
          ...
          data.friendsWithUserInfo.length > 0 ? (
            ...
            <div className="ml-5 text-gray-500">No friends found</div>
          )}
        </div>
      </div>
      ...
      {user && user.id === userId && (
        <>
          ...
          <div className="flex">
            ...
            <div>
              <p className="p-2 text-gray-400">
                {requests ? requests.completeRequests.length : 0}
              </p>
            </div>
          </div>
          ...
          <div>
            {requests && requests.completeRequests.length > 0 ? (
              ...
              <div className="ml-5 text-gray-500">No friend requests</div>
            )}
          </div>
        </>
      )}

...
function ProfileFriendsPage(){
  ...
  const {data, isLoading, isError} = trpc.profileRouter.fetchFriends.useQuery()
  console.log("friends: ", data)

    return(
        <div className="absolute top-2 left-4 ">
        {
          data && data.friendsWithUserInfo.map((friend)=>{
            return (
              <div className="relative  border border-gray-100 rounded-sm h-[120px] tbb:h-[80px] w-[260px] sb:w-[300px] sbb:w-[350px] tb:w-[330px]  tbbb:w-[350px] tbb:w-[500px] md:w-[520px] lgg:w-[400px] lggg:w-[500px]  mb-3 bg-white">
                ...
                <div className="flex space-x-36 mt-[70px]">
                  <div>
                    {" "}
                    <button className="bg-gradient-to-r  from-red-500 to-purple-500 hover:from-purple-500 hover:to-blue-500 text-white h-10 ml-32 sb:ml-40 sbb:ml-[200px] w-32 rounded transition duration-200  absolute  tbb:right-6 tbb:top-7">
                      Friend
                    </button>
                  </div>
                </div>

...
const GroupPageLinks: React.FC<GroupLinksProps> = ({ setActiveLink }) => {
  ...
  const isActive = (path: string): boolean => pathname === `/GroupPageLinks/${path}`;
  ...
  return (
    <section className="flex relative flex-col sm:flex-row justify-between items-center border border-gray-100 tb:ml-[130px] md:ml-[160px] tb:w-[290px] tbbb:w-[370px] tbb:w-[570px] md:w-[540px] mdc:w-[570px] mdd:w-[760px] lg:w-[770px] mddd:w-[570px] lgg:w-[750px] lggg:w-[940px]
